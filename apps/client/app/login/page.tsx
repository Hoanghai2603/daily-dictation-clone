            ...
            >
                <Card className="border-none shadow-[0_20px_50px_rgba(0,0,0,0.08)] rounded-[2rem] bg-card overflow-hidden ring-1 ring-primary/5">
                    <CardHeader className="space-y-3 text-center p-10 pb-4">
                        <div className="h-16 w-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-2 rotate-3 transition-transform hover:rotate-0">
                            <Lock className="h-8 w-8 text-primary" />
                        </div>
                        <CardTitle className="text-3xl font-heading font-black tracking-tight text-foreground">Welcome back</CardTitle>
                        <CardDescription className="text-base font-medium text-foreground/50 leading-relaxed">
                            Login to save your progress and compete with the community
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-6 p-10 pt-4">
                        <div className="grid grid-cols-1">
                            <Button variant="outline" className="h-12 rounded-xl mb-1 font-bold border-2 text-base">
                                <Chrome className="mr-3 h-5 w-5 text-red-500" /> Continue with Google
                            </Button>
                        </div>
                        <div className="relative my-4">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-[0.3em]">
                                <span className="bg-card px-6 text-foreground/20">or email login</span>
                            </div>
                        </div>
                        ...
                        <Button className="h-14 rounded-xl font-black text-lg mt-2 shadow-xl bg-primary shadow-primary/20">
                            Let&apos;s Go!
                        </Button>
                    </CardContent>
                    <CardFooter className="flex flex-col gap-4 text-center p-10 pt-0">
                        ...
                        <Link href="/forgot-password" title="Forgot Password?" className="text-xs font-black text-muted-foreground/40 uppercase tracking-widest hover:text-primary transition-colors">
